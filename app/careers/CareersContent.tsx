           ...
           <div className="container-max">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                 ...
                 <div className="relative">
                    <div className="aspect-square rounded-[3rem] overflow-hidden border border-stroke shadow-2xl relative">
                       <img src="https://images.unsplash.com/photo-1522071823991-b9671f30c46f?auto=format&fit=crop&q=80&w=2070" alt="Culture" className="w-full h-full object-cover grayscale" />
                       <div className="absolute inset-0 bg-brand/10 mix-blend-overlay" />
                    </div>
                    <motion.div 
                      animate={{ y: [0, -20, 0] }}
                      transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                      className="absolute -bottom-10 -right-10 p-10 bg-white border border-stroke rounded-[2rem] shadow-xl space-y-4"
                    >
                       <Zap size={32} className="text-brand" />
                       <p className="text-2xl font-black uppercase tracking-tight text-text-primary leading-none">HIGH <br /> PERFORMANCE.</p>
                    </motion.div>
                 </div>
              </div>
           </div>
