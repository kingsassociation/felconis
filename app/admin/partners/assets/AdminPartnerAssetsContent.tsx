    ...
    <div className="space-y-12">
      ...
      <div className="flex justify-between items-end">
         <div className="space-y-4">
            <h1 className="text-4xl font-black uppercase tracking-tighter text-text-primary">PARTNER <span className="text-brand">ASSETS.</span></h1>
            <p className="text-text-muted text-[10px] font-black uppercase tracking-widest">MANAGE DOWNLOADABLE RESOURCES AND BRAND KITS FOR PARTNERS</p>
         </div>
         <button 
         ...
         >
            {isAdding ? "CANCEL" : "ADD NEW ASSET"} <Plus size={16} />
         </button>
      </div>
            ...
            <form onSubmit={handleAdd} className="space-y-8">
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase tracking-widest text-brand ml-1">ASSET TITLE</label>
                     <input name="title" required type="text" placeholder="SALES PLAYBOOK" className="input-field h-14 px-6 text-sm font-bold uppercase transition-all" />
                  </div>
                  <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase tracking-widest text-brand ml-1">CATEGORY</label>
                  ...
                  <div className="space-y-3">
                     <label className="text-[10px] font-black uppercase tracking-widest text-brand ml-1">FILE SIZE (E.G. 12.5 MB)</label>
                  ...
                  <div className="space-y-3 lg:col-span-2">
                     <label className="text-[10px] font-black uppercase tracking-widest text-brand ml-1">DOWNLOAD URL</label>
         ...
         <table className="w-full text-left">
            <thead>
               <tr className="bg-surface/50 border-b border-stroke">
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-text-muted">ASSET NAME</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-text-muted">CATEGORY</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-text-muted">DETAILS</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-text-muted text-right pr-12">ACTIONS</th>
               </tr>
            </thead>
               ...
               {assets.length > 0 ? (
                 assets.map((asset: any, i: number) => (
                    <tr key={i} className="group hover:bg-surface transition-colors">
                       ...
                       <td className="px-10 py-8">
                          ...
                          <p className="text-[8px] font-black uppercase tracking-widest text-text-muted">{asset.type} FILE</p>
                       </td>
                 ...
                 <tr>
                    <td colSpan={4} className="py-24 text-center">
                       <p className="text-[10px] font-black uppercase tracking-widest text-text-muted">No assets found in library.</p>
                    </td>
                 </tr>
               )}
            </tbody>
      ...
      <div className="p-10 bg-brand text-white rounded-[2.5rem] flex items-center justify-between shadow-xl shadow-brand/10">
         <div className="flex items-center gap-6">
            ...
            <div>
               <p className="text-xs font-black uppercase tracking-tight">Partner Resource Distribution</p>
               <p className="text-[10px] font-black uppercase tracking-widest opacity-60">Assets are automatically available to all verified partners.</p>
            </div>
         </div>
      </div>
    </div>
